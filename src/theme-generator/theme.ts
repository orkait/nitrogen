...
const theme = {
    border: borderGenerator("a0"),
    boxModel: boxModelGenerator("c0"),
    boxShadow: boxShadowGenerator("e0"),
    color: colorGenerator("f0"),
    coordinates: coordinatesGenerator("h0"),
    dimensions: dimensionsGenerator("j0"),
    display: displayGenerator("k0"),
    flex: flexGenerator("m0"),
    fontProperties: fontPropertiesGenerator("o0"),
    listStyle: listStyleGenerator("q0"),
    opacity: opacityGenerator("s0"),
    overflow: overflowGenerator("u0"),
    position: positionGenerator("w0"),
    text: textGenerator("x0"),
    visibility: visibilityGenerator("z0"),
    zIndex: zIndexGenerator("A0"),
    transform: transformGenerator("C0"),
    image: imageGenerator("E0"),
    interactivity: interactivityGenerator("G0"),
}
